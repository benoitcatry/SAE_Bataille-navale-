...
public class BattleShipDecider extends Decider {
    ...
    private int count;
    private static ControllerBatleShipMouse controllerBatleShipMouse;
    public int end=0;
        ...
        if (id_Bot == 0) {
            ...
            do {
                ...
                if (n)
                    ...
                    sens = 'H';
            } while (!battleShipStageModel.Verifpeutetreposer(ship, x, y, taille, sens) || !battleShipStageModel.ShipPlayer2[m].setCordonnerShip(y, x, sens));
            placeToutPartShip(1, stageModel, x, y, sens);

        }
    }
    public boolean surGrille(double y, int x,int taille, char sens){
        if(sens == 'V'){
            if (x>9 || y+taille>9 || 0>y || 0>x){
    ...
    public void placeToutPartShip(int idplayer, BattleShipStageModel stageModel, int X, int Y, char sens) {
        ...
        if (idplayer == 0) {
            ...
            bateau = stageModel.getship(battleShipControler.numJ2, stageModel.ShipPlayer2);
            for (int i = 0; i < bateau.getNbRows(); i++) {
    ...
    public void end(){
        ...
        if(model.getIdPlayer()==0){
            ...
            battleShipControler.player2playmode0(stageModel);
            ...
            battleShipControler.player1playmode0(stageModel);
